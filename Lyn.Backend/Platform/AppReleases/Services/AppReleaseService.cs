...
using Lyn.Backend.Infrastructure.Storage.DTOs;
    ...
    IAppReleaseRepository appReleaseRepository) : IAppReleaseService
{
    ...
    public async Task<Result> UploadReleaseAsync(UploadReleaseRequest request, CancellationToken ct)
    {
        ...
        var exists = await appReleaseRepository.ExistsAsync(request.Version, request.Type, ct);
        if (exists)
        {
        ...
        try
        {
            ...
            await appReleaseRepository.CreateAsync(release, ct);
    ...
    {
        var latestDownloads = await appReleaseRepository.GetLatestAsync();
    ...
    public async Task<Result<FileDownloadDto>> DownloadAsync(int id, CancellationToken ct = default)
    {
        ...
        var appRelease = await appReleaseRepository.GetAsync(id, ct);
        ...
        _ = appReleaseRepository.IncrementDownloadCountAsync(appRelease.Id, ct);
