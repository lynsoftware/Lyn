...
{
    private readonly AppReleaseService _sut;
    private readonly Mock<IFileValidator> _mockFileValidator;
    private readonly Mock<IStorageService> _mockStorageService;
    private readonly Mock<IAppReleaseRepository> _mockReleaseRepository;

    public AppReleaseServiceTests()
    {
        var mockLogger = new Mock<ILogger<AppReleaseService>>();
